...
var Renderer = {
  ...
  imagesFromEntities: function(entities)
  {
    ...
    for( var i=0; i < entities.length; i++ )
    {
      ...
      img.setAttribute( 'style', 'max-width: 100%; max-height: 450px' ); // TODO adjustable
  ...
  renderTweet: function (tweet, useColors, nameAttribute, topLevel) {
    ...
    if(tweet.quoted_status) {
      ...
      Renderer.expandQuote(tweet, tweetSpace, !(topLevel && OptionsBackend.get('auto_expand_quotes')));
    }
